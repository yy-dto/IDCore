...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1329"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* ^caseSensitive = true
* ^valueSet = "http://terminology.hl7.org/ValueSet/coverage-financial-exception"
* ^content = #complete
* #retired "Retired" "Retired persons have all copays and deductibles reduced."
* #foster "Foster child" "Children in the foster care have all copays and deductibles waived."