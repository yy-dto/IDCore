...
* ^contact.name = "WHO Collaborating Center for the Family of International Classifications (FIC) in the Netherlands"
* ^contact.telecom.system = #url
* ^contact.telecom.value = "https://www.whofic.nl/over-het-centrum"
