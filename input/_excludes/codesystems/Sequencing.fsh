CodeSystem: Sequencing
Id: v3-Sequencing
Title: "Sequencing"
Description: "Specifies sequence of sort order."
* ^language = #en
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.113"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
