CodeSystem: AdjudicationErrorCodes
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1053"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = true
...
* ^content = #complete
* #a001 "Missing Identifier" "Missing Identifier"
* #a002 "Missing Creation Date" "Missing Creation Date"