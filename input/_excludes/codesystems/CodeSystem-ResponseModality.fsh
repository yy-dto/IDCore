...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.109"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* ^property[=].type = #code
* #B "Batch" "Query response to be sent as an HL7 Batch."
* #B ^property[0].code = #status
* #B ^property[=].valueCode = #active
* #B ^property[+].code = #internalId
* #B ^property[=].valueCode = #10153
* #R "Real Time" "Query response to occur in real time."
* #R ^property[0].code = #status
* #R ^property[=].valueCode = #active
* #R ^property[+].code = #internalId
* #R ^property[=].valueCode = #10151
* #T "Bolus" "Query response to sent as a series of responses at the same time without the use of batch formatting."
* #T ^property[0].code = #status
* #T ^property[=].valueCode = #active
* #T ^property[+].code = #internalId
* #T ^property[=].valueCode = #10152