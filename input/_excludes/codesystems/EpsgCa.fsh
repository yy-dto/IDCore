CodeSystem: EpsgCa
Id: epsg-ca
Title: "European Petroleum Survey Group Geodetic Parameter Dataset Coordinate Axis"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.6.279"
* ^version = "2.0.1"
* ^status = #retired
* ^experimental = false
* ^date = "2021-11-09T10:00:00+10:00"
* ^publisher = "TBD - External Body"
* ^contact.name = "International Association of Oil & Gas Producers"
* ^caseSensitive = true
* ^content = #not-present