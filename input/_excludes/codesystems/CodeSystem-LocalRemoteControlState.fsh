...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.66"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* ^property[=].type = #code
* #L "Local" "An equipment can either work autonomously ('Local' control state)."
* #L ^property[0].code = #status
* #L ^property[=].valueCode = #active
* #L ^property[+].code = #internalId
* #L ^property[=].valueCode = #10894
* #R "Remote" "An equipment can be controlled by another system, e.g., LAS computer ('Remote' control state)."
* #R ^property[0].code = #status
* #R ^property[=].valueCode = #active
* #R ^property[+].code = #internalId
* #R ^property[=].valueCode = #10895