...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.1010"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* #SHA-1 ^property[0].code = #status
* #SHA-1 ^property[=].valueCode = #active
* #SHA-1 ^property[+].code = #internalId
* #SHA-1 ^property[=].valueCode = #17386
* #SHA-256 "secure hash algorithm - 256" "This algorithm is defined in FIPS PUB 180-2: Secure Hash Standard."
* #SHA-256 ^property[0].code = #status
* #SHA-256 ^property[=].valueCode = #active
* #SHA-256 ^property[+].code = #internalId
* #SHA-256 ^property[=].valueCode = #17387