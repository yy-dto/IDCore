CodeSystem: Hl7ITSVersionCode
Id: v3-hl7ITSVersionCode
Title: "HL7 ITS Version Code"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.1092"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* ^property[=].type = #code
* #XMLV1PR1 "XMLV1PR1" "XML ITS version 1 pre-release 1."
* #XMLV1PR1 ^property[0].code = #status
* #XMLV1PR1 ^property[=].valueCode = #active
* #XMLV1PR1 ^property[+].code = #internalId
* #XMLV1PR1 ^property[=].valueCode = #20091