...
* ^url = "https://nahdo.org/sopt"
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.3.221.5"
* ^version = "1.0.1"
* ^status = #active
* ^experimental = false
* ^date = "2022-06-07T00:00:00-00:00"
* ^publisher = "National Association of Health Data Organizations (NAHDO)"
* ^contact.name = "National Association of Health Data Organizations (NAHDO); 124 South 400 East, Suite 220, Salt Lake City, Utah 84111-5312"
* ^contact.telecom[0].system = #phone
* ^contact.telecom[=].value = "801-532-2299"
* ^contact.telecom[+].system = #email
* ^contact.telecom[=].value = "info@nahdo.org"
* ^caseSensitive = true
* ^content = #not-present