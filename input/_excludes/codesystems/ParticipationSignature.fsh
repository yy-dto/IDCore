...
Description: """A set of codes specifying whether and how the participant has attested his participation through a signature and or whether such a signature is needed.
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.89"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* ^property[=].type = #code
* #I "intended" "The particpant intends to provide a signature."
* #I ^property[0].code = #status
* #I ^property[=].valueCode = #active
* #I ^property[+].code = #internalId
* #I ^property[=].valueCode = #13977
