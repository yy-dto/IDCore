...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1388"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* ^caseSensitive = true
* ^valueSet = "http://terminology.hl7.org/ValueSet/ex-procedure-type"
* ^content = #complete
* #primary "Primary procedure" "The first procedure in a series required to produce and overall patient outcome."
* #secondary "Secondary procedure" "The second procedure in a series required to produce and overall patient outcome."