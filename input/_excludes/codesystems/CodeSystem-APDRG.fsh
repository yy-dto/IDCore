...
* ^contact.name = "3M Health Information Systems, Inc.; 575 West Murray Boulevard, Salt Lake City, UT 84123, USA"
* ^contact.telecom[0].system = #phone
* ^contact.telecom[=].value = "+1 800 367 2447"
* ^contact.telecom[+].system = #url
* ^contact.telecom[=].value = "http://www.3mhis.com"
* ^caseSensitive = true
* ^content = #not-present