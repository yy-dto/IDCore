CodeSystem: DeviceAlertLevel
Id: v3-DeviceAlertLevel
Title: "DeviceAlertLevel"
Description: "Domain values for the Device.Alert\\_levelCode"
* ^language = #en
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.31"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
