CodeSystem: AHA_NUBC_PatientDischargeStatus
Id: AHANUBCPatientDischargeStatus
Title: "AHA NUBC Patient Discharge Status Codes"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.6.301.5"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
