CodeSystem: ISO31662retired
Id: v3-ISO3166-2retired
Title: "ISO 3166 3 Character Country Codes"
...
* ^identifier.value = "urn:oid:2.16.2"
* ^version = "2.0.1"
* ^status = #retired
* ^experimental = false
* ^date = "2019-03-20"
* ^publisher = "ISO"
* ^contact.name = "International Standards Organization (ISO)"
* ^caseSensitive = true
