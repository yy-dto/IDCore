...
* include codes from system $v3-ParticipationType
    where concept is-a #_ParticipationInformationGenerator
* exclude $v3-ParticipationType#_ParticipationInformationGenerator