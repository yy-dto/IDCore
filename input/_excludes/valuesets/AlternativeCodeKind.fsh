...
* ^url = "http://terminology.hl7.org/ValueSet/codesystem-altcode-kind"
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.3.952"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* include codes from system $codesystem-altcode-kind