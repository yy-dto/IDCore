ValueSet: PharmacySupplyRequestFulfillerRevisionRefusalReasonCode
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20344"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* include codes from system $v3-ActReason
    where concept is-a #_PharmacySupplyRequestFulfillerRevisionRefusalReasonCode