ValueSet: XActMoodOrdPrms
Id: v3-xActMoodOrdPrms
Title: "x_ActMoodOrdPrms"
...
* ^extension.extension[=].valueString = "OrderPromise"
* ^extension.url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.16735"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
