ValueSet: AdditionalLocator
Id: v3-AdditionalLocator
Title: "AdditionalLocator"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.10651"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-AddressPartType where concept is-a #ADL