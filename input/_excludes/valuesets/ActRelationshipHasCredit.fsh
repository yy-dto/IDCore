ValueSet: ActRelationshipHasCredit
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.19972"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-ActRelationshipType where concept is-a #CREDIT