ValueSet: SnodentDentalToothFurcationSiteInternational
Id: v3-SnodentDentalToothFurcationSiteInternational
Title: "SnodentDentalToothFurcationSiteInternational"
Description: """The SNODENT identifiers for the relative location of a human tooth root that is being observed for furcation.
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20557"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
