ValueSet: SecurityTrustAccreditationObservationType
Id: v3-SecurityTrustAccreditationObservationType
Title: "SecurityTrustAccreditationObservationType"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20532"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-08-07"
...
* include codes from system $v3-ActCode where concept is-a #TRSTACCRDOBS