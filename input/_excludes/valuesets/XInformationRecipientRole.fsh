ValueSet: XInformationRecipientRole
...
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "received&"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.16772"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* $v3-RoleClass#ASSIGNED
* $v3-RoleClass#CAREGIVER
* $v3-RoleClass#GUAR
* $v3-RoleClass#PROV
* $v3-RoleClass#PRS