ValueSet: RoleClassPartitive
Id: v3-RoleClassPartitive
Title: "RoleClassPartitive"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.10429"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-RoleClass where concept is-a #_RoleClassPartitive
* exclude $v3-RoleClass#_RoleClassPartitive