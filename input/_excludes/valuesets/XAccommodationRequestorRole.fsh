ValueSet: XAccommodationRequestorRole
Id: v3-xAccommodationRequestorRole
Title: "x_AccommodationRequestorRole"
Description: "***No description***"
* ^language = #en
* ^extension[0].extension[0].url = "name"
* ^extension[=].extension[=].valueString = "Name:Class"
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "accommodationRequestor"
...
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "requesting&"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
* ^extension[=].extension[=].valueString = "Name:Role:scoper:Entity"
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "(scoping&)|scoper"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.19352"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
