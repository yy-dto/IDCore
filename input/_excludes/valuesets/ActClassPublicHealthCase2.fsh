ValueSet: ActClassPublicHealthCase2
Id: v3-ActClassPublicHealthCase2
Title: "ActClassPublicHealthCase2"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20455"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-ActClass where concept is-a #HCASE