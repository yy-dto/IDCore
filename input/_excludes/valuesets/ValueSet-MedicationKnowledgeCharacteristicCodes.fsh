ValueSet: MedicationKnowledgeCharacteristicCodes
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.3.1337"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* include codes from system MedicationKnowledgeCharacteristicCodes