...
* include codes from system RoleCode where concept is-a #_CoveredPartyRoleType
...
* exclude RoleCode#_ClaimantCoveredPartyRoleType
* exclude RoleCode#_ProgramEligiblePartyRoleType
* exclude RoleCode#_IndividualInsuredPartyRoleType
* exclude RoleCode#_SubscriberCoveredPartyRoleType
* exclude RoleCode#_DependentCoveredPartyRoleType