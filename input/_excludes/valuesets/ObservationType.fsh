...
* include codes from system $v3-ActCode where concept is-a #_ObservationType
...
* exclude $v3-ActCode#_ObservationType
* exclude $v3-ActCode#_ObservationIssueTriggerCodedObservationType
* exclude $v3-ActCode#_GeneticObservationType