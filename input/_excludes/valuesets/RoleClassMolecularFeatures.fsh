ValueSet: RoleClassMolecularFeatures
...
* ^extension[=].extension[=].valueString = "molecularFeature"
...
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "owning&"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
* ^extension[=].extension[=].valueString = "Sort:Entity:playedRole:Role"
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "AA_______"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20390"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
