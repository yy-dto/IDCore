ValueSet: SnodentJawTypeInternational
Id: v3-SnodentJawTypeInternational
Title: "SnodentJawTypeInternational"
Description: """The SNODENT identifiers for the two jaws (mandible and maxilla).
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20568"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
