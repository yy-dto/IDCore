ValueSet: RoleClassMutualRelationship
Id: v3-RoleClassMutualRelationship
Title: "RoleClassMutualRelationship"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.19316"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-RoleClass where concept is-a #_RoleClassMutualRelationship
* exclude $v3-RoleClass#_RoleClassMutualRelationship