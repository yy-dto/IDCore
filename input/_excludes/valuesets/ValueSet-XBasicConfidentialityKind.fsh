ValueSet: XBasicConfidentialityKind
Id: v3-xBasicConfidentialityKind
Title: "x_BasicConfidentialityKind"
Description: """**Description:** Used to enumerate the typical confidentiality constraints placed upon a clinical document.
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.16926"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
