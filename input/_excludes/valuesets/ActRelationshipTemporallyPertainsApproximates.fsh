ValueSet: ActRelationshipTemporallyPertainsApproximates
Id: v3-ActRelationshipTemporallyPertainsApproximates
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20509"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-08-07"
