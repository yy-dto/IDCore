ValueSet: ActClassAccession
Id: v3-ActClassAccession
Title: "ActClassAccession"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20195"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-ActClass where concept is-a #ACSN