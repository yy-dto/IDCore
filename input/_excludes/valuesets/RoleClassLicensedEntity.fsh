ValueSet: RoleClassLicensedEntity
Id: v3-RoleClassLicensedEntity
Title: "RoleClassLicensedEntity"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.16773"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-RoleClass where concept is-a #LIC