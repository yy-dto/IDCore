ValueSet: AddressRepresentationUse
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.17860"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-EntityNameUse where concept is-a #_NameRepresentationUse
* exclude $v3-EntityNameUse#_NameRepresentationUse