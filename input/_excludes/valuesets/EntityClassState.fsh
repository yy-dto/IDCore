ValueSet: EntityClassState
Id: v3-EntityClassState
Title: "EntityClassState"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.19455"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system $v3-EntityClass where concept is-a #STATE