ValueSet: RoleClassMember
Id: v3-RoleClassMember
Title: "RoleClassMember"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20145"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from system RoleClass where concept is-a #MBR