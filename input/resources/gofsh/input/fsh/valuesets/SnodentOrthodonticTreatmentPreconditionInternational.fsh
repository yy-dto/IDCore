ValueSet: SnodentOrthodonticTreatmentPreconditionInternational
Id: v3-SnodentOrthodonticTreatmentPreconditionInternational
Title: "SnodentOrthodonticTreatmentPreconditionInternational"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20563"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
