ValueSet: XRoleClassAccommodationRequestor
Id: v3-xRoleClassAccommodationRequestor
Title: "x_RoleClassAccommodationRequestor"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.19382"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
