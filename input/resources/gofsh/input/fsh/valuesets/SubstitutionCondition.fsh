ValueSet: SubstitutionCondition
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.17719"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
...
* include codes from valueset Conditional
* include codes from valueset XSubstitutionConditionNoneOrUnconditional