ValueSet: VerificationResult_communication_method
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.3.1401"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2018-10-31"
...
* include codes from system $verificationresult-communication-method