...
* ^url = "http://fdasis.nlm.nih.gov"
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.9"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2022-08-23T00:00:00-00:00"
* ^publisher = "U.S. Food and Drug Administration (FDA)"
* ^contact.name = "U.S. Food and Drug Administration (FDA)"
* ^contact.telecom.system = #url
* ^contact.telecom.value = "https://www.fda.gov/"
