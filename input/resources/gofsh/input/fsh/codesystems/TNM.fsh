...
* ^url = "https://cancerstaging.org"
* ^version = "1.0.1"
* ^status = #active
* ^experimental = false
* ^date = "2022-01-14T00:00:00-00:00"
* ^publisher = "American Joint Committee on Cancer"
* ^contact.name = "American Joint Committee on Cancer; 633 N. Saint Clair St., Chicago, IL 60611-3211"
* ^contact.telecom[0].system = #email
* ^contact.telecom[=].value = "ajcc@facs.org"
* ^contact.telecom[+].system = #phone
* ^contact.telecom[=].value = "(312) 202-5205"
* ^contact.telecom[+].system = #url
* ^contact.telecom[=].value = "https://cancerstaging.org/"
