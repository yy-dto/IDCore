...
* ^identifier.value = "urn:oid:2.16.840.1.113883.6.256"
* ^version = "1.0.2"
* ^status = #active
* ^experimental = false
* ^date = "2022-03-31T00:00:00-00:00"
* ^publisher = "RSNA (Radiological Society of North America)"
* ^contact.name = "RSNA (Radiological Society of North America); 820 Jorie Blvd., Suite 200, Oak Brook, IL 60523-2251 USA"
* ^contact.telecom[0].system = #email
* ^contact.telecom[=].value = "informatics@rsna.org"
* ^contact.telecom[+].system = #url
* ^contact.telecom[=].value = "https://www.rsna.org/"
* ^contact.telecom[+].system = #phone
* ^contact.telecom[=].value = "1-800-381-6660"
