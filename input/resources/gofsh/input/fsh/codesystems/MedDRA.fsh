...
* ^identifier.value = "urn:oid:2.16.840.1.113883.6.163"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
...
* ^contact.name = "International Council for Harmonisation of Technical Requirements for Pharmaceuticals for Human Use (ICH)"
* ^contact.telecom.system = #url
* ^contact.telecom.value = "https://www.ich.org/page/contact"
