...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1160"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* ^content = #complete
* #311405 "Dentist" "Dentist General Practitioner (DDS, DDM)."
* #604215 "Ophthalmologist" "Ophthalmologist."
* #604210 "Optometrist" "Optometrist."