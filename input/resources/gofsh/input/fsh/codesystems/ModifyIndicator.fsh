...
* ^identifier.value = "urn:oid:2.16.840.1.113883.5.81"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20"
...
* ^property[=].type = #code
* #M "Modified subscription" "Modified subscription to a query server."
* #M ^property[0].code = #status
* #M ^property[=].valueCode = #active
* #M ^property[+].code = #internalId
* #M ^property[=].valueCode = #10149
* #N "New subscription" "New subscription to a query server."
* #N ^property[0].code = #status
* #N ^property[=].valueCode = #active
* #N ^property[+].code = #internalId
* #N ^property[=].valueCode = #10148