...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1188"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* ^caseSensitive = true
* ^valueSet = "http://terminology.hl7.org/ValueSet/vision-product"
* ^content = #complete
* #lens "Lens" "A lens to be fitted to a frame to comprise a pair of glasses."
* #contact "Contact Lens" "A lens to be fitted for wearing directly on an eye."