...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.1.1142"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
* ^date = "2023-09-19T21:10:28+00:00"
...
* #phone "Phone" "Referrals may be accepted over the phone."
...
* #self "Self-referral" "Referrals may be accepted via self-referral."