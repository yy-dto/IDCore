...
* ^identifier.value = "urn:oid:2.16.840.1.113883.2.20.5.1"
* ^version = "3.0.1"
* ^status = #active
* ^experimental = false
* ^date = "2019-03-20T00:00:00-04:00"
* ^publisher = "Canada Health Infoway"
* ^contact.name = "Canada Health Infoway"
* ^contact.telecom.system = #url
* ^contact.telecom.value = "https://infocentral.infoway-inforoute.ca/en/standards/canadian/pclocd-loinc"
* ^caseSensitive = false
* ^content = #not-present