ValueSet: StatisticCertaintySubcomponentRating
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.4.642.3.1361"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* include codes from system StatisticCertaintySubcomponentRating