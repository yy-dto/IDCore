...
* include codes from system ActReason where concept is-a #_ControlActReason
...
* exclude ActReason#_MedicationOrderAbortReasonCode
* exclude ActReason#_MedicationOrderReleaseReasonCode
* exclude ActReason#_PharmacySupplyRequestRenewalRefusalReasonCode
* exclude ActReason#_SupplyOrderAbortReasonCode