ValueSet: RoleClassMolecularPart
...
* ^extension[=].extension[=].valueString = "molecularPart"
...
* ^extension[=].extension[+].url = "value"
* ^extension[=].extension[=].valueString = "whole&"
* ^extension[=].url = "http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp"
* ^extension[+].extension[0].url = "name"
...
* ^identifier.value = "urn:oid:2.16.840.1.113883.1.11.20389"
* ^version = "3.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2014-03-26"
