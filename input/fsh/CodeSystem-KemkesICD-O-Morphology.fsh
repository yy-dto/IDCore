CodeSystem: KemkesICDOMorphologyCS
Title: "ICD-0 Morphology"
Description: "Created by: Fadhil Muhammad"
* ^meta.versionId = "1"
* ^meta.lastUpdated = "2024-02-05T12:02:11.903+07:00"
* ^url = "http://terminology.kemkes.go.id/CodeSystem/icd-o-morphology"
* ^version = "3.2"
* ^status = #active
