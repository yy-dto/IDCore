CodeSystem: KemkesICDOTopographyCS
Title: "ICD-0 Topography"
Description: "Created by: Fadhil Muhammad"
* ^url = "http://terminology.kemkes.go.id/CodeSystem/icd-o-topography"
* ^version = "3.2"
* ^status = #active
...
* #C31.8 "Overlapping lesion of sinuses accessory"
