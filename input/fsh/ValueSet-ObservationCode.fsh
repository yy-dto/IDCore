...
* include codes from system http://terminology.kemkes.go.id/CodeSystem/examination
* include codes from system http://snomed.info/sct where concept is-a #116312005
* include codes from system http://snomed.info/sct where concept is-a #116337000
* include codes from system http://snomed.info/sct where concept is-a #297268004